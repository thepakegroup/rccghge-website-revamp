...
export default function page({ params }: { params: { title: string } }) {
  ...
  let src = "/images/lead-pastor1.svg";
  let title = "Our Lead Pastor";
  let name = "Pastor John Omewa";
  let textBody = <LeadTextBody/>

  if (params.title === "associate") {
    src = "/images/associate-pastor.svg";
    title = "Our Associate Pator";
    name = "Pastor (Dr.) Ibi Omewah, EdD, LPC-S, NCC";
   textBody = <AssociateTextBody />;
        ...
        <div className="flex flex-col items-center justify-center lg:justify-start gap-2 ">
          ...
          <div className="image-container relative max-w-sm pt-8 lg:pt-0 flex flex-col items-center justify-center gap-2 ">
            ...
            <div className=" w-80 h-64 lg:h-80   relative aspect-square">
              ...
              <ImageFill src={src} className="z-10 " />
            ...
            <h1 className="font-bold text-lg sm:text-xl mt-2">{name}</h1>
          </div>
        </div>
        {/* text-section */}
