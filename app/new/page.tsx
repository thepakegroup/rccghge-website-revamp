    ...
    <div className="page-spacing  relative sm:text-lg [&_a]:underline [&_a]:text-[#1ca8db]">
      <div className="">
        <MotionDiv
          ...
          <h1 className="text-lg sm:text-xl">Plan your visit to our church</h1>
          <p>
            Everyone is welcomed at RCCG HGE. It is our sincere desire that all
            men, women, boys and girls come into a saving knowledge of our Lord
            Jesus Christ and experience daily the power of His eternal love. A
            believer can increasingly grow into an intimate, vibrant
            relationship with Christ as he or she becomes more grounded in His
            Word.
          </p>
        </MotionDiv>
        {/* video section */}
        <div className="space-y-10 mt-32 sm:mt-auto  ">
          <MotionH1
            variants={slideInFromBottom(1, 0)}
            initial="hidden"
            whileInView={"visible"}
            viewport={{ once: true }}
            className="font-bold wrapper text-center  text-3xl sm:text-5xl ">
        ...
        <div className="grid grid-cols-1 gap-8 w-full mx-auto lg:grid-cols-[1fr_auto_1fr] wrapper">
          <div className="space-y-2 md:space-y-3  ">
            ...
            <p>
              ...
              3rd Wednesday, it’s Man Church. Every 2nd and 4th Wednesday, it’s
              the Gathering of the Girls. Let’s connect with God and each other
              around DYNAMIC WORSHIP, RELEVANT TEACHING, BIBLICAL APPLICATION
              and LOTS of FUN with music, food, games and more.
            </p>
          </div>
          <Separator orientation="vertical" />
          <div className="space-y-8  ">
            <div className="space-y-2 md:space-y-3  ">
              <TitleBorderTop title="NextGen Youth" />
              <p>
                NextGen Youth meets at 7:00 pm in person with a check-in time of
                6:30 pm. Visit{" "}
      ...
      <div className="space-y-8 sm:space-y-12 wrapper max-w-screen-2xl ">
        ...
        <div className="grid grid-cols-1 gap-8 w-full mx-auto  lg:grid-cols-[1fr_auto_1fr]">
          <div className="space-y-2 md:space-y-5  ">
            ...
            <p>
              There are four entrances to the parking lots on the south side of
              W. Camp Wisdom Road where our Worship Center is located. Please
              arrive 15-20 minutes prior to the start of service because the
              parking lots fill up quickly. Parking lot attendants, wearing
              bright yellow shirts, are available to help you navigate the lots.
            </p>
            <p>
            ...
            <p>
              ...
              <br />
              We offer shuttle service on Sundays from satellite parking sites,
              east of the Worship Center, before and after each service.
            </p>
          </div>
          <Separator orientation="vertical" />
          <div className="space-y-2 md:space-y-5  ">
            ...
            <p>
              The four parking lot entrances on the south side of W. Camp Wisdom
              Road lead to the Worship Center’s main foyer. Once you enter the
              Worship Center, you’ll find friendly greeters to assist you with
              directions to the sanctuary and restrooms. An usher will help you
              find a seat. Communion, prayer, praise and worship, giving and
              biblical teaching are key components of our worship service each
              week. You will experience dynamic praise and worship, comprising a
              blend of contemporary and traditional gospel music. Our Senior
              Pastor, Pastor John Omewah, delivers an energetic, inspiring and
              challenging Word from the Lord. Sunday morning services are
              approximately one hour and 45 minutes in length
            </p>
          </div>
        </div>
      </div>
