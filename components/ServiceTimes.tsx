...
export default function ServiceTimes() {
  return (
    <div className="flex items-center my-10  lg:gap-8 ">
      <div className="lg:w-2/5 lg:h-[380px] relative  lg:block">
      ...
      <div className=" w-full lg:w-3/5 h-full  flex flex-col gap-5">
       ...
       <TitleBorderTop title="Our Service Times"/>
        ...
        <ScrollArea className="w-full">
          <div className=" card-container w-full h-60 lg:h-64  flex item-center gap-5">
            <div className="card border-2 w-52 relative  rounded-lg">
              ...
              <div className="card-content py-2 px-1">
                <p className="card-title font-bold capitalize text-lg">
                  sunday service
                </p>
                <p className="desc ">
        ...
        <LearnMoreBtn url="/service" className="w-32" />
      </div>
    </div>
  );
}
