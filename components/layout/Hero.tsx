...
export default function Hero() {
  ...
  return (
    <div
      ref={scope}
      className={cn(
        "w-full min-h-[150px]  md:h-[250px] lg:h-[300px] xl:h-[450px] [@media(min-width:2560px)]:h-[800px] max-h-[800px] text-center text-white bg-blue-950 flex flex-col justify-center items-center px-4 relative overflow-hidden",
